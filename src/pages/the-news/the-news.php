...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white transition-colors duration-300">
            ...
            <div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden mb-0 md:mb-4">
                        <a href="#" class="flex items-center">
                            <div class="">
                                <img src="https://images.unsplash.com/photo-1624701928517-44c8ac49d93c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Post thumbnail" class="h-20 w-20 object-cover rounded-lg" />
                            </div>
                            <div class="p-3 flex flex-col justify-center">
                                <h3 class="text-sm font-bold mb-2">Post Heading</h3>
                                <p class="text-xs text-gray-500">11 Oct 2024</p>
                    ...
                    <div class="rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden mb-0 md:mb-4">
                        <a href="#" class="flex items-center">
                            <div class="">
                                <img src="https://images.unsplash.com/photo-1510557880182-3d4d3cba35a5?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Post thumbnail" class="h-20 w-20 object-cover rounded-lg" />
                            </div>
                            <div class="p-3 flex flex-col justify-center">
                                <h3 class="text-sm font-bold mb-2">Post Heading</h3>
                                <p class="text-xs text-gray-500">11 Oct 2024</p>
                    ...
                    <div class="rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden mb-0 md:mb-4">
                        <a href="#" class="flex items-center">
                            <div class="">
                                <img src="https://images.unsplash.com/photo-1496181133206-80ce9b88a853?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    ...
                    <div class="rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden">
                        <a href="#" class="flex items-center">
                            <div class="">
                                <img src="https://images.unsplash.com/photo-1550921464-9f7a27f99edc?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Post thumbnail" class="h-20 w-20 object-cover rounded-lg" />
                            </div>
                            <div class="p-3 flex flex-col justify-center">
                                <h3 class="text-sm font-bold mb-2">Post Heading</h3>
                                <p class="text-xs text-gray-500">11 Oct 2024</p>
    ...
    <!-- Why choose us -->
    <section>
        <div class="bg-secondary dark:bg-gray-900 py-12 px-4 mb-10">
